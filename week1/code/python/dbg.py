...
class DBG:
    ...
    def print_debug_info(self):
        key,node = self.nodes.popitem()
        kmer,idx = self.kmer2idx.popitem()
        print("Nodes:", type(self.nodes), type(key), type(node))
        print("kmer2idx:", type(self.kmer2idx), type(kmer), type(idx))
        print("Children:", type(node._children), type(node._children.pop()))
        print("Kmer:", type(node.kmer))
        print("Max Depth Child:", type(node.max_depth_child))
